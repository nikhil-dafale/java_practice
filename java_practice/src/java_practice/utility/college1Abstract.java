...
import java_practice.Address;
import java_practice.College1;
import java_practice.Employee;
import java_practice.PersonalInformation;

public abstract class college1Abstract {

	//the college1 return type is ref of college1 object
	public static College1 getCollege1Record() {
...
//				personalInformation.setDob(new Date("21-06-1992"));
				...
				employee1.setType(employeeType.PROFESSOR);
...
//				employee2.setType(employeeType.PRINCIPAL);
//
